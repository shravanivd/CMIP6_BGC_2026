...
data_path_obs = '../../../observations_bgc/sal/salanity_ORAS5_1998-2024_1deg_surf_IO_clim.nc'
data_path_esm = '../data/climatology/sal/ensmean_sal.nc'
fig_path  = '../figs/'
...
cbar.set_label('Ocean Surface Salinity (psu)')


plt.tight_layout(rect=[0, 0, 0.9, 0.93])

plt.savefig(fig_path + 'sal_ensmean_occi.png', dpi=300)
plt.show()
