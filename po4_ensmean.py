...
data_path_obs = '../data/climatology/po4/'
data_path_esm = '../data/climatology/po4/'
fig_path  = '../figs/new/'
...
cbar.set_label('Phosphate (mmol m$^{-3}$)')


plt.tight_layout(rect=[0, 0, 0.9, 0.93])

plt.savefig(fig_path + 'po4_ensmean.png', dpi=300)
plt.show()
