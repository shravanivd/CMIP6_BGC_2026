...
data_path = '/mnt/f/cmip6_bgc_2025/analysis/data/bias/chl/occci/'
...
levels = [-0.30, -0.24, -0.18, -0.12, -0.06, 0,
           0.06, 0.12, 0.18, 0.24, 0.30]

colors = [
    "#2171B5", "#6BAED6", "#A9CBE5", "#DEEBF7", "#FFFFFF", "#FFFFFF",
...
cax = fig.add_axes([0.28, 0.17, 0.62, 0.024])
...
plt.savefig(fig_path + 'chl_bias_occci.png', dpi=300)
plt.show()
