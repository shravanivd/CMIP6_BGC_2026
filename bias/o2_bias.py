...
data_path = '../data/bias/o2/'
fig_path  = '../figs/'

files = [
    'o2_ACCESS-ESM1-5_bias.nc',
    'o2_CanESM5_bias.nc',
    'o2_CanESM5-1_bias.nc',
    'o2_CMCC-ESM2_bias.nc',
    'o2_CNRM-ESM2-1_bias.nc',
    'o2_GFDL-CM4_bias.nc',
    'o2_GFDL-ESM4_bias.nc', 
    #'o2_IITM-ESM_bias.nc',
    'o2_IPSL-CM5A2-INCA_bias.nc',
    'o2_IPSL-CM6A-LR_bias.nc',
    'o2_IPSL-CM6A-LR-INCA_bias.nc',
    'o2_MIROC-ES2L_bias.nc', 
    'o2_MPI-ESM-1-2-HAM_bias.nc',
    'o2_MPI-ESM1-2-HR_bias.nc',
    'o2_MPI-ESM1-2-LR_bias.nc',
    'o2_NorESM2-LM_bias.nc', 
    'o2_NorESM2-MM_bias.nc',
    'o2_UKESM1-0-LL_bias.nc'
]
...
cbar.set_label('Oxygen Bias (mmol m$^{-3}$)', fontsize=12)
cbar.ax.tick_params(labelsize=10)

plt.suptitle('Oxygen Bias for Indian Ocean (Model − Observation)', fontsize=16, y=0.95)

#plt.tight_layout(rect=[0, 0, 0.9, 0.93])
#plt.subplots_adjust(wspace=0.15, hspace=0.25)
plt.savefig(fig_path + 'Oxygen bias plot.png', dpi=300)
plt.show()
