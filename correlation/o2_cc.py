...
data_path = '../data/cc/DO/'
fig_path  = '../figs/'

files = [
    'o2_ACCESS-ESM1-5_cc.nc',
    'o2_CanESM5_cc.nc',
    'o2_CanESM5-1_cc.nc',
    'o2_CMCC-ESM2_cc.nc',
    'o2_CNRM-ESM2-1_cc.nc',
    'o2_GFDL-CM4_cc.nc',
    'o2_GFDL-ESM4_cc.nc',
    'o2_IPSL-CM5A2-INCA_cc.nc',
    'o2_IPSL-CM6A-LR_cc.nc',
    'o2_IPSL-CM6A-LR-INCA_cc.nc',
    'o2_MIROC-ES2L_cc.nc',
    'o2_MPI-ESM-1-2-HAM_cc.nc',
    'o2_MPI-ESM1-2-HR_cc.nc',
    'o2_MPI-ESM1-2-LR_cc.nc',
    'o2_NorESM2-LM_cc.nc',
    'o2_NorESM2-MM_cc.nc',
    'o2_UKESM1-0-LL_cc.nc'
]

labels = [
    'ACCESS-ESM1-5','CanESM5','CanESM5-1','CMCC-ESM2','CNRM-ESM2-1',
...
plt.suptitle(
    'Correlation of Surface Oxygen (1988–2014)',
    fontsize=15,
    y=0.95
)

plt.tight_layout(rect=[0, 0, 0.9, 0.93])
plt.savefig(fig_path + 'o2_cmip6_cc.png', dpi=300)
plt.show()
