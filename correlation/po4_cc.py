...
data_path = '../data/cc/po4/'
fig_path  = '../figs/'

files = [
    'po4_ACCESS-ESM1-5_cc.nc',
    'po4_CESM2_cc.nc',
    'po4_CESM2-FV2_cc.nc',
    'po4_CESM2-WACCM_cc.nc',
    'po4_CESM2-WACCM-FV2_cc.nc',
    'po4_CMCC-ESM2_cc.nc',
    'po4_CNRM-ESM2-1_cc.nc',
    'po4_GFDL-CM4_cc.nc',
    'po4_GFDL-ESM4_cc.nc',
    'po4_IPSL-CM5A2-INCA_cc.nc',
    'po4_IPSL-CM6A-LR_cc.nc',
    'po4_IPSL-CM6A-LR-INCA_cc.nc',
    'po4_MIROC-ES2L_cc.nc',
    'po4_MPI-ESM-1-2-HAM_cc.nc',
    'po4_MPI-ESM1-2-HR_cc.nc',
    'po4_MPI-ESM1-2-LR_cc.nc',
    'po4_NorESM2-LM_cc.nc',
    'po4_NorESM2-MM_cc.nc',
    'po4_UKESM1-0-LL_cc.nc'
]

labels = [
    'ACCESS-ESM1-5','CESM2','CESM2-FV2',
...
plt.suptitle(
    'Correlation of Surface Phosphate (1988–2014)',
    fontsize=15,
    y=0.95
)

plt.tight_layout(rect=[0, 0, 0.9, 0.93])
plt.savefig(fig_path + 'po4_cmip6_cc.png', dpi=300)
plt.show()
