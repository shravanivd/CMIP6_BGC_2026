...
data_path = '../data/cc/no3/'
fig_path  = '../figs/'

files = [
    'no3_ACCESS-ESM1-5_cc.nc',
    'no3_CanESM5_cc.nc',
    'no3_CanESM5-1_cc.nc',
    'no3_CESM2_cc.nc',
    'no3_CESM2-FV2_cc.nc',
    'no3_CESM2-WACCM_cc.nc',
    'no3_CESM2-WACCM-FV2_cc.nc',
    'no3_CMCC-ESM2_cc.nc',
    'no3_CNRM-ESM2-1_cc.nc',
    'no3_GFDL-ESM4_cc.nc',
    'no3_IPSL-CM5A2-INCA_cc.nc',
    'no3_IPSL-CM6A-LR_cc.nc',
    'no3_IPSL-CM6A-LR-INCA_cc.nc',
    'no3_MIROC-ES2L_cc.nc',
    'no3_MPI-ESM-1-2-HAM_cc.nc',
    'no3_MPI-ESM1-2-HR_cc.nc',
    'no3_MPI-ESM1-2-LR_cc.nc',
    'no3_NorESM2-LM_cc.nc',
    'no3_NorESM2-MM_cc.nc',
    'no3_UKESM1-0-LL_cc.nc'
]

labels = [
    'ACCESS-ESM1-5','CanESM5','CanESM5-1','CESM2','CESM2-FV2',
    'CESM2-WACCM','CESM2-WACCM-FV2','CMCC-ESM2','CNRM-ESM2-1',
    'GFDL-ESM4','IPSL-CM5A2-INCA','IPSL-CM6A-LR',
...
plt.suptitle(
    'Correlation of Surface Nitrate (1988–2014)',
    fontsize=15,
    y=0.95
)

plt.tight_layout(rect=[0, 0, 0.9, 0.93])
plt.savefig(fig_path + 'no3_cmip6_cc.png', dpi=300)
plt.show()
