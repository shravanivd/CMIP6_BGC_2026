...
data_path = '../data/cc/chl/'
fig_path  = '../figs/'

files = [
    'chl_ACCESS-ESM1-5_cc.nc',
    'chl_CanESM5_cc.nc',
    'chl_CanESM5-1_cc.nc',
    'chl_CESM2_cc.nc',
    'chl_CESM2-FV2_cc.nc',
    'chl_CESM2-WACCM_cc.nc',
    'chl_CESM2-WACCM-FV2_cc.nc',
    'chl_CMCC-ESM2_cc.nc',
    'chl_CNRM-ESM2-1_cc.nc',
    'chl_GFDL-CM4_cc.nc',
    'chl_GFDL-ESM4_cc.nc',
    'chl_IPSL-CM5A2-INCA_cc.nc',
    'chl_IPSL-CM6A-LR_cc.nc',
    'chl_IPSL-CM6A-LR-INCA_cc.nc',
    'chl_MIROC-ES2L_cc.nc',
    'chl_MPI-ESM-1-2-HAM_cc.nc',
    'chl_MPI-ESM1-2-HR_cc.nc',
    'chl_MPI-ESM1-2-LR_cc.nc',
    'chl_NorESM2-LM_cc.nc',
    'chl_NorESM2-MM_cc.nc',
    'chl_UKESM1-0-LL_cc.nc'
]
...
plt.suptitle(
    'Correlation of Surface Chlorophyll (1988–2014)',
    fontsize=15,
    y=0.95
)

plt.tight_layout(rect=[0, 0, 0.9, 0.93])
plt.savefig(fig_path + 'chl_cmip6_cc.png', dpi=300)
plt.show()
