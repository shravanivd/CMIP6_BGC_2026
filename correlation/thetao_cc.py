...
data_path = '../data/cc/thetao/'
fig_path  = '../figs/'

files = [
    'thetao_ACCESS-ESM1-5_cc.nc',
    'thetao_CanESM5_cc.nc',
    'thetao_CanESM5-1_cc.nc',
    'thetao_CESM2_cc.nc',
    'thetao_CESM2-FV2_cc.nc',
    'thetao_CESM2-WACCM_cc.nc',
    'thetao_CESM2-WACCM-FV2_cc.nc',
    'thetao_CMCC-ESM2_cc.nc',
    'thetao_CNRM-ESM2-1_cc.nc',
    'thetao_GFDL-CM4_cc.nc',
    'thetao_GFDL-ESM4_cc.nc',
    'thetao_IPSL-CM5A2-INCA_cc.nc',
    'thetao_IPSL-CM6A-LR_cc.nc',
    'thetao_IPSL-CM6A-LR-INCA_cc.nc',
    'thetao_MIROC-ES2L_cc.nc',
    'thetao_MPI-ESM-1-2-HAM_cc.nc',
    'thetao_MPI-ESM1-2-HR_cc.nc',
    'thetao_MPI-ESM1-2-LR_cc.nc',
    'thetao_NorESM2-LM_cc.nc',
    'thetao_NorESM2-MM_cc.nc',
    'thetao_UKESM1-0-LL_cc.nc'
]
...
plt.suptitle(
    'Correlation of Surface Temperature (1988–2014)',
    fontsize=15,
    y=0.95
)

plt.tight_layout(rect=[0, 0, 0.9, 0.93])
plt.savefig(fig_path + 'thetao_cmip6_cc.png', dpi=300)
plt.show()
