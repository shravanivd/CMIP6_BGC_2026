...
data_path = '../data/bias/si/'
fig_path  = '../figs'

files = [
    "si_CESM2_bias.nc",
    "si_CESM2-FV2_bias.nc",
    "si_CESM2-WACCM_bias.nc",
    "si_CESM2-WACCM-FV2_bias.nc",
    "si_CMCC-ESM2_bias.nc",
    "si_CNRM-ESM2-1_bias.nc", 
    "si_GFDL-ESM4_bias.nc",
    #"si_IITM-ESM_bias.nc",
    "si_IPSL-CM5A2-INCA_bias.nc",
    "si_IPSL-CM6A-LR_bias.nc",
    "si_IPSL-CM6A-LR-INCA_bias.nc",
    "si_MPI-ESM-1-2-HAM_bias.nc",
    "si_MPI-ESM1-2-HR_bias.nc",
    "si_MPI-ESM1-2-LR_bias.nc",
    "si_NorESM2-LM_bias.nc",
    "si_NorESM2-MM_bias.nc",
    "si_UKESM1-0-LL_bias.nc" 
]
...
cbar.set_label('Silicate Bias (mmol m$^{-3}$)', fontsize=12)
cbar.ax.tick_params(labelsize=10)

plt.suptitle('Silicate Bias for Indian Ocean (Model − Observation)', fontsize=16, y=0.95)

#plt.tight_layout(rect=[0, 0, 0.9, 0.93])
#plt.subplots_adjust(wspace=0.15, hspace=0.25)
plt.savefig(fig_path + 'si bias plot.png', dpi=300)
plt.show()
